...
namespace PlantTycoonHelper
{
    public class FlowerFormulaSeeder
    {
        ...
        public void Reseed()
        {
            ...
            flowerCalculator.SetFlowerFormula(FlowerType.Arthurium, FlowerType.Mela, true);
            ...
            flowerCalculator.SetFlowerFormula(FlowerType.Fourpetal, FlowerType.Rosaceae, true);
