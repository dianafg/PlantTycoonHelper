...
namespace PlantTycoonHelper
{
    public class SeedStorageSeeder
    {
        ...
        public void Reseed()
        {
            ...
            calculator.SetSeed(Tuple.Create('A', 2, 1), FlowerType.Venomous, PlantType.Lemonbush);
            ...
            calculator.SetSeed(Tuple.Create('A', 3, 6), FlowerType.Citrus, PlantType.PipeCactus);
            ...
            calculator.SetSeed(Tuple.Create('A', 4, 5), FlowerType.Aureus, PlantType.Bamboo);
            ...
            calculator.SetSeed(Tuple.Create('A', 4, 9), FlowerType.Rosaceae, PlantType.Lemonbush);
            ...
            calculator.SetSeed(Tuple.Create('B', 2, 5), FlowerType.Fragrant, PlantType.Fanleaf);
            calculator.SetSeed(Tuple.Create('B', 2, 6), FlowerType.Mela, PlantType.PearCactus);
            calculator.SetSeed(Tuple.Create('B', 2, 7), FlowerType.Mela, PlantType.BallCactus);
            calculator.SetSeed(Tuple.Create('B', 2, 8), FlowerType.Fragrant, PlantType.Bamboo);
            calculator.SetSeed(Tuple.Create('B', 2, 9), FlowerType.Arthurium, PlantType.PipeCactus);
            ...
            calculator.SetSeed(Tuple.Create('C', 1, 8), FlowerType.Blazing, PlantType.Weeper);
            ...
            calculator.SetSeed(Tuple.Create('C', 3, 7), FlowerType.Fourpetal, PlantType.Maple);
            ...
            calculator.SetSeed(Tuple.Create('C', 4, 5), FlowerType.Jalapa, PlantType.Weeper);
            calculator.SetSeed(Tuple.Create('C', 4, 6), FlowerType.Spotted, PlantType.Maranta);
            calculator.SetSeed(Tuple.Create('C', 4, 7), FlowerType.Jalapa, PlantType.Weeper);
            calculator.SetSeed(Tuple.Create('C', 4, 8), FlowerType.Nox, PlantType.Bamboo);
            calculator.SetSeed(Tuple.Create('C', 4, 9), FlowerType.Citrus, PlantType.Multiflora);
